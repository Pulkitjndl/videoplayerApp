...
import 'package:videoplayer/about_screen.dart';
import 'package:videoplayer/src/Containercontrols.dart';
import 'package:videoplayer/src/utils.dart';
...
class Fluttervideoplayer extends StatefulWidget {
  ...
  Fluttervideoplayer(
      ...
      @required this.flutterVolume,
      @required this.enableLooping,
      @required this.enableScaling,
      this.allowonlylandscape})
                      ...
                      children: <Widget>[
                          ...
                          child: widget.enableScaling
                              ? GestureDetector(
                                  ...
                                  child: Center(
                                    ...
                                    scale: _scaleFactor,
                                    child: AspectRatio(
                                      aspectRatio: Provider.of<Aspect>(context)
                                          .tap_count,
                        ...
                        Positioned(
                            ...
                            child: AnimatedOpacity(
                              ...
                              opacity: widget.allowonlylandscape
                                  ? 0.0
                                  : _hidebar
                                      ? 0.0
                                      : 1.0,
                        ...
                        Positioned(
                          ...
                          child: AnimatedOpacity(
                              ...
                              child: FlutterProgressBar(
                                controller: widget.controller,
                                progressvol: widget.flutterVolume,
                              )),
                        ),
                      ],
                    ),
